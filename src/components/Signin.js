...
createusers();
    ...
    <div className='container'>
        ...
        <>{regNo}</><button onClick={remove}>change and delete this Register Number</button>
<br/><br/>
        ...
        <div className='mail'><h3>Mail *</h3><input className='mail_value' onChange={(e)=>{setmail(e.target.value)}}/></div>
